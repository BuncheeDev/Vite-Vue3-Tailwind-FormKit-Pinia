<template>
    ...
    <div class="h-full w-screen   flex items-center mt-64">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            <div class="max-w-md">
                <div class="text-5xl font-dark font-bold">อย่าเข้ามั่ว</div>
                <p class="text-2xl md:text-3xl font-light leading-normal">Sorry we couldn't find this page. </p>
                <p class="mb-8">(404)</p>


                <RouterLink
                    class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-red-600 active:bg-red-600 hover:bg-blue-700"
                    to="/">Back to Home page</RouterLink>
            </div>
            <div class="max-w-lg">
